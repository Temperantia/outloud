            ...
            for (final String _interest in person.interests)
              Container(
                  ...
                  child: AutoSizeText(_interest.toUpperCase(),
                      style: const TextStyle(color: pinkBright, fontSize: 12)))
          ]),
      ...
      trailing: user.pendingFriends.contains(user.id)
          ? Column(children: <Widget>[
              Container(
                  ...
                  margin:
                      const EdgeInsets.only(left: 2.0, right: 2.0, bottom: 10),
          ...
          : (!user.requestedFriends.contains(person.id))
              ? Container(
                  ...
                  child: GestureDetector(
                      onTap: () =>
                          _dispatch(UserSendFriendRequest(user.id, person.id)),
    ...
    return ReduxConsumer<AppState>(builder: (BuildContext context,
      ...
      return View(
          ...
          child: ContentList(
              ...
              items: people,
              builder: (dynamic person) => _buildPerson(person as User, user)));
    });
  }
}
